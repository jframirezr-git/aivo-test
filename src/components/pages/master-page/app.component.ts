...
import { locale as menuEnglish } from '@models/menu/i18n/en';
import { locale as menuFrench } from '@models/menu/i18n/fr';
import { locale as menuGerman } from '@models/menu/i18n/de';
import { locale as menuPortuguese } from '@models/menu/i18n/pt';
